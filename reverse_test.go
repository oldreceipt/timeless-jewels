...
func TestReverseGloriousVanity(t *testing.T) {
	...
	testza.AssertLen(t, result[4291], 3)
	testza.AssertEqual(t, int32(10), result[4291][1210][statIDs[0]])
}
...
func TestReverseElegantHubris(t *testing.T) {
	...
	testza.AssertLen(t, result[99900], 1)
	testza.AssertEqual(t, int32(80), result[99900][1068][statIDs[0]])
}
